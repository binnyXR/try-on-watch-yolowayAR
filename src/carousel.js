...
class Carousel {
  ...
  constructor(
    ...
    if (this.inner == null) return Carousel.InvalidSliderStructure(sliderID);
   ...
   */
  getInnerLeft = () => {
    let res = parseInt(this.inner.style.transform.split("(")[1]);
  ...
  onMove = (e) => {
    ...
    this.inner.style.transform = `translate(${this.getInnerLeft() + dist}px)`;
